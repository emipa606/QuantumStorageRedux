// Source https://github.com/igor-tkachev/Portable.System.ValueTuple
//
...
namespace System {
    ...
    struct ValueTuple<T1, T2> : IEquatable<ValueTuple<T1, T2>>,
        ...
        public int CompareTo(ValueTuple<T1, T2> other) {
            var c = Comparer<T1>.Default.Compare(Item1, other.Item1); if (c != 0) return c;
    ...
    struct ValueTuple<T1, T2, T3, T4, T5> : IEquatable<ValueTuple<T1, T2, T3, T4, T5>>,
		...
		int IStructuralComparable.CompareTo(object other, IComparer comparer)
		{
			...
			c = comparer.Compare(Item2, objTuple.Item2); if (c != 0) return c;
			c = comparer.Compare(Item3, objTuple.Item3); if (c != 0) return c;
			c = comparer.Compare(Item4, objTuple.Item4); if (c != 0) return c;
    ...
    struct ValueTuple<T1, T2, T3, T4, T5, T6> : IEquatable<ValueTuple<T1, T2, T3, T4, T5, T6>>,
		...
		int IStructuralComparable.CompareTo(object other, IComparer comparer)
		{
			...
			c = comparer.Compare(Item3, objTuple.Item3); if (c != 0) return c;
			c = comparer.Compare(Item4, objTuple.Item4); if (c != 0) return c;
			c = comparer.Compare(Item5, objTuple.Item5); if (c != 0) return c;
    ...
    struct ValueTuple<T1, T2, T3, T4, T5, T6, T7> : IEquatable<ValueTuple<T1, T2, T3, T4, T5, T6, T7>>,
		...
		int IStructuralComparable.CompareTo(object other, IComparer comparer)
		{
			...
			c = comparer.Compare(Item4, objTuple.Item4); if (c != 0) return c;
			c = comparer.Compare(Item5, objTuple.Item5); if (c != 0) return c;
			c = comparer.Compare(Item6, objTuple.Item6); if (c != 0) return c;
    ...
    struct ValueTuple<T1, T2, T3, T4, T5, T6, T7, TRest> : IEquatable<ValueTuple<T1, T2, T3, T4, T5, T6, T7, TRest>>,
		...
		int IStructuralComparable.CompareTo(object other, IComparer comparer)
		{
			...
			c = comparer.Compare(Item5, objTuple.Item5); if (c != 0) return c;
			c = comparer.Compare(Item6, objTuple.Item6); if (c != 0) return c;
			c = comparer.Compare(Item7, objTuple.Item7); if (c != 0) return c;
